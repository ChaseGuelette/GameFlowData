...
for team in nba_teams:
    ...
    while True:
        try:
            ...
            roster = commonteamroster.CommonTeamRoster(team_id=team['id'], proxy=proxy_dict['https'])
            ...
            for index, row in roster_df.iterrows():
                ...
                while True:
                    try:
                        ...
                        stats = playercareerstats.PlayerCareerStats(player_id=player_id, proxy=proxy_dict['https'])
