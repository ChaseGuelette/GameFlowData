...
from src.models.calibration import CalibrationEvaluator, CalibrationReport
...
class TrainingOrchestrator:
    ...
    def _run_feature_selection(self, df: pd.DataFrame) -> dict:
        ...
        features["minutes_features"] = selector.select_features(
    ...
    def _run_sanity_check(self, pipeline: PlayerPropsModelPipeline, df: pd.DataFrame):
        ...
        try:
            ...
            for stat, p in preds.items():
                logger.info(f"  {stat.upper()}: Median={p.median:.2f}, Mean={p.mean:.2f}, Q10={p.q10:.2f}, Q90={p.q90:.2f}")
