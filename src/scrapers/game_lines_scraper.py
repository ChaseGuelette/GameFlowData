                ...
                for market in book.get('markets', []):
                    ...
                    for outcome in market.get('outcomes', []):
                        ...
                        rows_to_insert.append((
                            api_game_id, book_key, market_key, outcome_label,
                            line, odds, commence_time, home_team, away_team,
                            snapshot_ts, market_updated, book_updated, book_name
                        ))
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting Game Lines Scrape (H2H, Spreads, Totals)")
