---
name: "source-command-check-calibration"
description: "Run a full calibration health check — diagnostic drift, betting ROI, and comparison to training baseline"
---

# source-command-check-calibration

Use this skill when the user asks to run the migrated source command `check-calibration`.
...
>
> Also read `C:\Users\Chase\.Codex\projects\C--Users-Chase-Projects-GameFlowData\memory\calibration_log.md` if it exists — summarize the last 2 entries.
...
After presenting results, ask the user if they want to update the calibration log in memory. If yes, append a dated entry to `C:\Users\Chase\.Codex\projects\C--Users-Chase-Projects-GameFlowData\memory\calibration_log.md`.
