...
- Installing Codex slash commands
...
- `.Codex/commands/` - Slash commands for Codex

**Updated files:**
- `README.md` - Appended with Session-Driven Development section
- `AGENTS.md` - Appended with Solokit guidance (or created if missing)
...
1. Review the updated `README.md` and `AGENTS.md`
