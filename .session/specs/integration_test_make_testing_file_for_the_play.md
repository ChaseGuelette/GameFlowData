# Integration Test: make testing file for the player_prop_scraper.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make testing file for the player_prop_scraper.py file with a descriptive name for the integration test
