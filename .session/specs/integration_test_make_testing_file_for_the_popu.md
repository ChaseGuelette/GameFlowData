# Integration Test: make testing file for the populate_average_stats.py file, test each major function, do logic focused test that ensure returns and inputs are correct

<!--
TEMPLATE INSTRUCTIONS:
- Replace make testing file for the populate_average_stats.py file, test each major function, do logic focused test that ensure returns and inputs are correct with a descriptive name for the integration test
