# Integration Test: make a test for the nba_unified_scraper.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make a test for the nba_unified_scraper.py file with a descriptive name for the integration test
