# Integration Test: make a testing file for clinet.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make a testing file for clinet.py file with a descriptive name for the integration test
