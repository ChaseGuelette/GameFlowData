# Integration Test: build testing file for the backfill_opponent_allowed.py file, test each major function, do logic focused test that ensure returns and inputs are correct

<!--
TEMPLATE INSTRUCTIONS:
- Replace build testing file for the backfill_opponent_allowed.py file, test each major function, do logic focused test that ensure returns and inputs are correct with a descriptive name for the integration test
