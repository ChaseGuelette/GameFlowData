# Integration Test: make testing file for the update_league_position_averages.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make testing file for the update_league_position_averages.py file with a descriptive name for the integration test
