# Integration Test: make testing file for the injury_scraper_job.py file. The tests for this file should effectively test the functino in the espn_injury_scraper.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make testing file for the injury_scraper_job.py file. The tests for this file should effectively test the functino in the espn_injury_scraper.py file with a descriptive name for the integration test
