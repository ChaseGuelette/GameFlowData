...
- Replace make testing file for the backfill_team_ids.py file, test each major function, do logic focused test that ensure returns and inputs are correct with a descriptive name for the integration test
