# Integration Test: make testing file for the game_lines_scraper.py file

<!--
TEMPLATE INSTRUCTIONS:
- Replace make testing file for the game_lines_scraper.py file with a descriptive name for the integration test
