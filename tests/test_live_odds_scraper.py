...
class TestLiveOddsScraper(unittest.TestCase):
    ...
    def test_data_integrity(self, mock_get, mock_execute_values):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = [{
            "id": "g1", "commence_time": "2024-01-01", "home_team": "H", "away_team": "A",
            "bookmakers": [{"key": "b1", "title": "B1", "last_update": "2024-01-01",
                "markets": [{"key": "spreads", "last_update": "2024-01-01",
