...
#         # Mock select_features_per_quantile to return a dict
#         mock_features = {0.1: ["feature_1"], 0.5: ["feature_1"], 0.9: ["feature_1"]}
...
#         mock_pipeline_instance.minutes_model.all_feature_names = ["f1"]
#         mock_pipeline_instance.rate_models = {}
