...
class CalibrationEvaluator:
    ...
    def evaluate_betting_performance(
        ...
        over_roi = self._calculate_roi(
            over_bets['over_hit'], 
            over_bets['over_odds']
        )
        under_roi = self._calculate_roi(
            under_bets['under_hit'], 
            under_bets['under_odds']
        )
